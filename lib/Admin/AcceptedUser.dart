...
import 'package:star_event/Admin/AcceptedUserDetails.dart';
...
class UserAccept extends StatefulWidget {
  UserAccept();
  @override
  _UserAcceptState createState() => _UserAcceptState();
}
...
class _UserAcceptState extends State<UserAccept> {
  ...
  Future<List> getData() async {
    ...
    var url =
        Uri.parse("http://5howapp.com/StarLoginAndRegister/AcceptedUser.php");
