...
import 'package:star_event/Admin/AdminInitialPage.dart';
import 'package:star_event/Admin/AdminProfile.dart';
...
class AdminHomepage extends StatefulWidget {
  ...
  int index;
  AdminHomepage(this.index);

  @override
  _AdminHomepageState createState() => _AdminHomepageState(index);
}
...
class _AdminHomepageState extends State<AdminHomepage>
  ...
  int index;
  _AdminHomepageState(this.index);
