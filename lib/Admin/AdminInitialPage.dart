...
import 'package:star_event/Admin/UserDetailsScreenAdmin.dart';
...
class AdminIntitialPage extends StatefulWidget {
  AdminIntitialPage();
  @override
  _AdminIntitialPageState createState() => _AdminIntitialPageState();
}

class _AdminIntitialPageState extends State<AdminIntitialPage> {
  _AdminIntitialPageState();
  late List result;
  ...
  Future<List> getData() async {
    ...
    var url = Uri.parse("http://5howapp.com/StarLoginAndRegister/getUsers.php");
