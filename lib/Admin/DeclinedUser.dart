...
import 'package:star_event/Admin/RejectedUserDetails.dart';
...
class UserDecline extends StatefulWidget {
  UserDecline();
  @override
  _UserDeclineState createState() => _UserDeclineState();
}

class _UserDeclineState extends State<UserDecline> {
  _UserDeclineState();
  late List result;
  ...
  Future<List> getData() async {
    ...
    var url =
        Uri.parse("http://5howapp.com/StarLoginAndRegister/DeclinedUser.php");
