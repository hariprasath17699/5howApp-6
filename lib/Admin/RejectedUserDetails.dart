...
class RejectedUserDetailsPage extends StatefulWidget {
  String Name;
  String Interest;
  String Image;
  String DOB;
  ...
  @override
  _RejectedUserDetailsPageState createState() => _RejectedUserDetailsPageState(
      Name, Image, DOB, Proof, email, Phone, Profilelink, Interest);
}

class _RejectedUserDetailsPageState extends State<RejectedUserDetailsPage> {
  ...
  String Profilelink;
  String Interest;
  _RejectedUserDetailsPageState(this.Name, this.Image, this.DOB, this.Proof,
