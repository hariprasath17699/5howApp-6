...
class UserdetailsAccept extends StatefulWidget {
  String Name;
  String Interest;
  String Image;
  String DOB;
  ...
  @override
  _UserdetailsAcceptState createState() => _UserdetailsAcceptState(
      Name, Image, DOB, Proof, email, Phone, Profilelink, Interest);
}

class _UserdetailsAcceptState extends State<UserdetailsAccept> {
  String Name;
  String Image;
  String DOB;
  String Proof;
  ...
  String Profilelink;
  String Interest;
  _UserdetailsAcceptState(this.Name, this.Image, this.DOB, this.Proof,
      this.email, this.Phone, this.Profilelink, this.Interest);
  final reason = TextEditingController();
  // Future _Accept(String email) async {
  //   var url =
  //       ("https://starappeprodix.000webhostapp.com/starapp/UserRequestAccept.php");
  //   Dio dio = new Dio();
  //   var fields = {
  //     'starstatus': "Accepted",
  //     'Logintype': "StarLogin",
