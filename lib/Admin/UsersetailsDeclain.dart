...
class UserdetailsDecline extends StatefulWidget {
  String Name;
  String Interest;
  String Image;
  String DOB;
  ...
  @override
  _UserdetailsDeclineState createState() => _UserdetailsDeclineState(
      Name, Image, DOB, Proof, email, Phone, Profilelink, Interest);
}

class _UserdetailsDeclineState extends State<UserdetailsDecline> {
  String Name;
  String Image;
  String DOB;
  String Proof;
  ...
  String Profilelink;
  String Interest;
  _UserdetailsDeclineState(this.Name, this.Image, this.DOB, this.Proof,
  ...
  //   var url =
  //   ("https://starappeprodix.000webhostapp.com/starapp/UserRequestDecline.php");
  //   Dio dio = new Dio();
  //   var fields = {
  //     'starstatus': "Declined",
  //     'Logintype': "UserLogin",
  ...
  Acceptmail(TextEditingController reason) async {
