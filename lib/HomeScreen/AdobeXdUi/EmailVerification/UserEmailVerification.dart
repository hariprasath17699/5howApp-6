...
//   String email;
//   UserEmailVerification({required this.email});
//   @override
//   _UserEmailVerificationState createState() =>
//       _UserEmailVerificationState(email);
// }
//
...
//   _UserEmailVerificationState(this.email);
//
//   void verify(pin) {
...
//     var url =
//         "https://starappeprodix.000webhostapp.com/starapp/userVerification.php";
//     Dio dio = new Dio();
//
//     var fields = {
//       'email': email,
