...
class StarFavouriteStar extends StatefulWidget {
  StarFavouriteStar();
  @override
  _StarFavouriteStarState createState() => _StarFavouriteStarState();
}

class _StarFavouriteStarState extends State<StarFavouriteStar> {
  _StarFavouriteStarState();
  late List result;
  ...
  Future<List> getData() async {
    ...
    var url =
        Uri.parse("http://5howapp.com/StarLoginAndRegister/GetFavourite.php");
