...
class StarBookingSessionsShow extends StatefulWidget {
  DateTime selectedDate;
  StarBookingSessionsShow({required this.selectedDate});
  @override
  _StarBookingSessionsShowState createState() =>
      _StarBookingSessionsShowState(selectedDate);
}

class _StarBookingSessionsShowState extends State<StarBookingSessionsShow> {
  DateTime selectedDate;
  _StarBookingSessionsShowState(this.selectedDate);
  late List result;
