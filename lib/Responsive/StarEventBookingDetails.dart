...
class StarEventBookingDetails extends StatefulWidget {
  String image;
  String name;
  String Event;
  String EventDate;
  ...
  @override
  _StarEventBookingDetailsState createState() => _StarEventBookingDetailsState(
      image,
      name,
      Event,
      EventDate,
...
class _StarEventBookingDetailsState extends State<StarEventBookingDetails> {
  String image;
  String name;
  String event;
  String eventDate;
