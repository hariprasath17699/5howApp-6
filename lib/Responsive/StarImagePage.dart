...
import 'ProfileWidgetStarImage.dart';
import 'StarImageDetailsPage.dart';
...
class StarImagesPage extends StatefulWidget {
  String image1;
  String name;
  String email;
  StarImagesPage(this.image1, this.name, this.email);
  @override
  _StarImagesPageState createState() =>
      _StarImagesPageState(image1, name, email);
}

class _StarImagesPageState extends State<StarImagesPage> {
  String image1;
  String name;
  String email;
  _StarImagesPageState(this.image1, this.name, this.email);
  late List result;
...
class UserHomeScreen extends StatefulWidget {
  ...
  String name;
  UserHomeScreen(
      {Key? key, required this.list, required this.image1, required this.name})
      : super(key: key);

  @override
  _UserHomeScreenState createState() =>
      _UserHomeScreenState(list, image1, name);
}
...
class _UserHomeScreenState extends State<UserHomeScreen> {
  ...
  String image1;
  String name;
  _UserHomeScreenState(this.list, this.image1, this.name);
                      ...
                      children: <Widget>[
                        Container(
                          child: Padding(
                            ...
                            child: ProfileWidgetStarImagesPage(
                              onClicked: () async {},
                              imagePath: image1,
                            ),
                          ),
