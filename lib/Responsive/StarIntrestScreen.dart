...
class StarInterestScreen extends StatefulWidget {
  ...
  String interest;
  StarInterestScreen(
      {required this.email, required this.country, required this.interest});

  @override
  _StarInterestScreenState createState() =>
      _StarInterestScreenState(email, interest, country);
}
...
class _StarInterestScreenState extends State<StarInterestScreen> {
  ...
  String interest;
  String country;
  _StarInterestScreenState(this.email, this.interest, this.country);
