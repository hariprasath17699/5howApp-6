...
import 'package:star_event/User/HomePage/EventBookingDetails.dart';
...
class UserEventJoinScreen extends StatefulWidget {
  String image;
  String email;
  String name;
  String Interest;
  UserEventJoinScreen(
      ...
      required this.Interest});
  @override
  _UserEventJoinScreenState createState() =>
      _UserEventJoinScreenState(image, email, name, Interest);
}

class _UserEventJoinScreenState extends State<UserEventJoinScreen> {
  String image;
  String email;
  String name;
  String interest;
  _UserEventJoinScreenState(this.image, this.email, this.name, this.interest);
