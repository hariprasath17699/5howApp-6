...
class StarNotification extends StatefulWidget {
  StarNotification();
  @override
  _StarNotificationState createState() => _StarNotificationState();
}

class _StarNotificationState extends State<StarNotification> {
  _StarNotificationState();
  late List result;
  ...
  Future<List> getData() async {
    ...
    var url = Uri.parse(
        "http://5howapp.com/StarLoginAndRegister/Zoom/UpcomingEvents.php");
