...
class StarBookingJoinEventDetailsScreen extends StatefulWidget {
  String topic;
  String duration;
  String password;
  String email;
  ...
  @override
  _StarBookingJoinEventDetailsScreenState createState() =>
      _StarBookingJoinEventDetailsScreenState(
        topic,
        duration,
        password,
        email,
...
class _StarBookingJoinEventDetailsScreenState
    extends State<StarBookingJoinEventDetailsScreen> {
  String topic;
  String duration;
  String password;
  String email;
