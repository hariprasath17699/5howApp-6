...
import 'package:star_event/Responsive/Favourite/StarFavouriteStar.dart';
import 'package:star_event/Responsive/StarEventCalender.dart';

import 'StarProfile.dart';
import 'Starhomepage.dart';

class StarHomepage extends StatefulWidget {
  static final routeName = '/superAdminHome';
  int index;
  StarHomepage(this.index);

  @override
  _StarHomepageState createState() => _StarHomepageState(index);
}
