...
import 'package:star_event/Star/Notification/StarNotification.dart';
import 'package:star_event/User/Search/Search.dart';

import 'StarFilter.dart';
import 'StarHome.dart';

class StarSearchBarAdmin extends StatefulWidget {
  String name;
  String image;

  StarSearchBarAdmin({required this.name, required this.image});

  @override
  _StarSearchBarAdminState createState() =>
      _StarSearchBarAdminState(name, image);
}

class _StarSearchBarAdminState extends State<StarSearchBarAdmin> {
  String name;
  String image;

  _StarSearchBarAdminState(this.name, this.image);
    ...
    switch (stateTextWithIcon) {
      case ButtonState.idle:
        ...
        Future.delayed(Duration(seconds: 5), () async {
          ...
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => StarFilter()));
        });
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => StarNotification()));
                    },
                    child: Stack(
                      children: [
                        Container(
                          padding: EdgeInsets.only(left: 0, right: 20, top: 40),
                          child: new SvgPicture.asset(
