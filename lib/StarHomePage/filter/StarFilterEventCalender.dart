...
import 'package:star_event/Responsive/StarBookingSessionsShow.dart';
import 'package:star_event/Responsive/Zoom/EventCreation.dart';
...
class StarFilterEventCalender extends StatefulWidget {
  DateTime selecteddate;
  StarFilterEventCalender({required this.selecteddate});
  @override
  _StarFilterEventCalenderState createState() =>
      _StarFilterEventCalenderState(selecteddate);
}

class _StarFilterEventCalenderState extends State<StarFilterEventCalender> {
  DateTime selecteddate;
  _StarFilterEventCalenderState(this.selecteddate);
  late List result;
  ...
  Future<List> getData() async {
    ...
    var url = Uri.parse(
        "http://5howapp.com/StarLoginAndRegister/Zoom/Zoom/StarEventSelectedDate.php");
          ...
          builder: (context, snapshot) {
            ...
            return snapshot.hasData
                ? new StarEventCalender1(
                    list: snapshot.data!, SelectedDate: selecteddate)
                : new Center(
...
class StarEventCalender1 extends StatefulWidget {
  ...
  DateTime SelectedDate;
  StarEventCalender1({required this.list, required this.SelectedDate});
  @override
  _StarEventCalender1State createState() =>
      _StarEventCalender1State(list, SelectedDate);
}
...
class _StarEventCalender1State extends State<StarEventCalender1> {
  ...
  DateTime selectedDate;
  _StarEventCalender1State(this.list, this.selectedDate);
    ...
    _calendarCarouselNoHeader = CalendarCarousel<Event>(
      ...
      onDayPressed: (DateTime date, List<Event> events) {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => StarEventCalender1(
                      SelectedDate: date,
                      list: list,
                    )));
      },
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              StarBookingSessionsShow(selectedDate: selectedDate),
            ],
          ),
        ));
  }
