...
import 'package:star_event/StarHomePage/Starhomepage.dart';

class StarInterestScreen extends StatefulWidget {
  static final routeName = '/editBakery';
  String email;
  StarInterestScreen(this.email);

  @override
  _StarInterestScreenState createState() => _StarInterestScreenState(email);
}

class _StarInterestScreenState extends State<StarInterestScreen> {
  ...
  String email;
  _StarInterestScreenState(this.email);
  Future _updateDetails(
    ...
    var url = "http://5howapp.com/StarLoginAndRegister/updateStar.php";
    Dio dio = new Dio();
