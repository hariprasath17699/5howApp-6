...
import 'package:star_event/Responsive/Zoom/UserJoinEventDetailsScreen.dart';
...
class DateFilterEventCalender extends StatefulWidget {
  DateTime selecteddate;
  DateFilterEventCalender({required this.selecteddate});
  @override
  _DateFilterEventCalenderState createState() =>
      _DateFilterEventCalenderState(selecteddate);
}

class _DateFilterEventCalenderState extends State<DateFilterEventCalender> {
  DateTime selecteddate;
  _DateFilterEventCalenderState(this.selecteddate);
  late List result;
  ...
  Future<List> getData() async {
    ...
    var url = Uri.parse(
        "http://5howapp.com/StarLoginAndRegister/Zoom/Zoom/UserDateFilterSessions.php");
    ...
    _calendarCarouselNoHeader = CalendarCarousel<Event>(
      ...
      onDayPressed: (DateTime date, List<Event> events) {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => DateFilterEventCalender(
                      selecteddate: date,
                    )));
      },
