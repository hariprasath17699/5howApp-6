...
import 'package:star_event/User/Calender/DateFilterEventcalender.dart';
...
class UserEventCalender extends StatefulWidget {
  UserEventCalender();
  @override
  _UserEventCalenderState createState() => _UserEventCalenderState();
}

class _UserEventCalenderState extends State<UserEventCalender> {
  _UserEventCalenderState();
  late List result;
  ...
  Future<List> getData() async {
    ...
    var url = Uri.parse(
        "http://5howapp.com/StarLoginAndRegister/UserShowBookings.php");
...
//      firstDayOfWeek: 4,
      ...
      height: MediaQuery.of(context).size.height / 2.5 < 200
