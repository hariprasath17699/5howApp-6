...
class UserFavouriteStar extends StatefulWidget {
  UserFavouriteStar();
  @override
  _UserFavouriteStarState createState() => _UserFavouriteStarState();
}

class _UserFavouriteStarState extends State<UserFavouriteStar> {
  _UserFavouriteStarState();
  late List result;
