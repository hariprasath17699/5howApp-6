...
class _UserFilterState extends State<UserFilter> {
  ...
  Future<List> getData() async {
    ...
    var url = Uri.parse(
        "http://5howapp.com/StarLoginAndRegister/Zoom/Zoom/filterOption.php");

    var response = await client.post(url, headers: {
      "Accept": "application/json",
      "Access-Control_Allow_Origin": "*"
    }, body: {
      "filter1": storage.getItem("filter1"),
      "filter2": storage.getItem("filter2"),
      "filter3": storage.getItem("filter3"),
      "filter4": storage.getItem("filter4"),
    });
    print(response.body);
