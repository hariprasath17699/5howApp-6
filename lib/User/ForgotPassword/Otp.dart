...
import 'package:star_event/User/ForgotPassword/NewPassword.dart';
...
class _OtpScreenState extends State<OtpScreen> {
  ...
  void verify(currentText) {
    var result = EmailAuth.validate(receiverMail: email, userOTP: currentText);
    if (result) {
    ...
    print(EmailAuth.validate(receiverMail: email, userOTP: currentText));
  }
