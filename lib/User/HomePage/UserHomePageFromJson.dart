...
import 'package:star_event/User/HomePage/UserStarDetailsScreenList.dart';
import 'package:star_event/User/Search/SearchBar.dart';
                                              ...
                                              onTap: () {
                                                try {
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                          builder: (context) => UserStarDetailsScreenList(
                                                              Name: list[index]
                                                                  ['username'],
                                                              Interest: list[
                                                                      index]
