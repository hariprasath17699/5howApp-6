...
import 'EventBookingDetails.dart';
...
class UserStarDetailsScreenList extends StatefulWidget {
  String Name;
  String Interest;
  String Image1;
  String email;
  ...
  @override
  _UserStarDetailsScreenListState createState() =>
      _UserStarDetailsScreenListState(
          Name, Interest, Image1, email, fullname, country, status, dob);
}

class _UserStarDetailsScreenListState extends State<UserStarDetailsScreenList> {
  String Name;
  String Interest;
  String image1;
  String email;
...
class _UserHomeScreenState extends State<UserHomeScreen> {
  ...
  Future<List> getupcommingsession() async {
    ...
    return uploadupcomingsession(dataRecieved[0]['topic']);
  }

  uploadupcomingsession(String topic) async {
    var client = http.Client();
    var url1 = Uri.parse(
