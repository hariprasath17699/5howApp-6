...
class AccountSettings extends StatefulWidget {
  ...
  @override
  _AccountSettingsState createState() =>
      _AccountSettingsState(username, password, dob, email, image);
}
  ...
  Widget buildTextWithIconWithMinState() {
    return ProgressButton.icon(
      iconedButtons: {
        ...
        ButtonState.fail:
            IconedButton(text: "Failed", color: Colors.red.shade300),
        ButtonState.success: IconedButton(text: "success", color: Colors.green)
      },
      ...
      case ButtonState.idle:
        ...
        Future.delayed(Duration(seconds: 2), () async {
          ...
          // _updateDetails();
            ...
            storage.setItem("profileimage", _imageFile!.path);
            print(res);
          }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<Username>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            storage.setItem("_pickedFile", snapshot.data!.data.image);
            return SafeArea(
              child: Scaffold(
