...
import 'package:star_event/User/ProfilePage/AccountSettings.dart';
import 'package:star_event/User/ProfilePage/Becomeastar.dart';
import 'package:star_event/User/ProfilePage/UserInterestScreen.dart';
...
Future<Username> fetchAlbum() async {
  ...
  if (response.statusCode == 200) {
    ...
    // then parse the JSON.
    storage.setItem("userprofiledata", response);
    return Username.fromJson(
        jsonDecode(storage.getItem("userprofiledata").data));
  } else {
...
class _UserProfilePageState extends State<UserProfilePage> {
              ...
              return Scaffold(
                ...
                body: ListView(
                  ...
                  children: [
                    ...
                    Center(
                        child: buildUpgradeButton(snapshot.data!.data.email)),
                    const SizedBox(height: 24),
                    Center(
  ...
  Widget buildUpgradeButton(String email) => ButtonWidget(
        color: Color.fromRGBO(60, 34, 95, 10),
        text: "   I'm a show-host  ",
        onClicked: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => Areyouastar(email: email)));
        },
      );
